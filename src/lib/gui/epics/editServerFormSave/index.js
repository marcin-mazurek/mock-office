...
import { InvalidRequestError, ResourceNotFoundError, UnsupportedStatusError, ConnectionError } from '../../packages/mock-office-service/lib/errors';
  ...
  Observable.from(mockOfficeService.editServer(action.id, action.values))
    ...
    .catch((e) => {
      if (e instanceof InvalidRequestError ||
        ...
        return Observable.of(failedAction('Something went wrong. Please try again or refresh page.'));
