import MockOfficeService, { ConnectionError, InvalidRequestError, UnsupportedStatusError, ResourceNotFoundError, ServerError } from '../lib';
...
describe('MockOfficeService', () => {
  ...
  describe('.addBehaviour', () => {
    it('should throw InvalidPayloadError on response status 400', () => {
      ...
      return mos.addBehaviour('server id', {})
        .catch((e) => {
          expect(e).toBeInstanceOf(InvalidRequestError);
        });
    });
  ...
  describe('.getBehaviour', () => {
    it('should throw ResourceNotFoundError on response status 404', () => {
      ...
      return mos.getBehaviour('server-id', 'behaviour-id')
        .catch((e) => {
  ...
  describe('.startServer', () => {
    it('should throw ResourceNotFoundError on response status 404', () => {
      ...
      return mos.startServer('server-id')
        .catch((e) => {
          expect(e).toBeInstanceOf(ResourceNotFoundError);
        });
    });
  ...
  describe('.editServer', () => {
    ...
    it('should throw InvalidPayloadError on response status 400', () => {
      ...
      return mos.editServer('server-id')
        .catch((e) => {
          expect(e).toBeInstanceOf(InvalidRequestError);
          expect(e.message).toEqual(errorMessage);
        });
  ...
  describe('.removeBehaviour', () => {
    ...
    it('should throw InvalidPayloadError on response status 400', () => {
      ...
      return mos.removeBehaviour('server-id')
        .catch((e) => {
          expect(e).toBeInstanceOf(InvalidRequestError);
          expect(e.message).toEqual(errorMessage);
        });
