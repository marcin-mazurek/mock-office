...
storiesOf('EditableField', module)
  .add('edit bolded text', () => (
    <div>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum pulvinar purus tellus,
      ...
      tristique senectus et netus et malesuada fames ac turpis egestas.</div>
  ));
