...
export default class Queue {
  ...
  addTask(taskConfig) {
    ...
    this.serverEE.emit(events.TASK_ADDED, { queueId: this.id, taskId: task.id });
  ...
  removeTask(taskId) {
    ...
    this.serverEE.emit(events.TASK_REMOVED, { queueId: this.id, taskId: task.id });
  }
  ...
  backupTasks() {
    return this.tasks.map((task) => {
      const taskConfig = Object.assign({}, task);
      taskConfig.id = undefined;
      taskConfig.job = undefined;
      return taskConfig;
    });
  }
