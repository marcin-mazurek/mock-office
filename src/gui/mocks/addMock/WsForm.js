...
import { init as initAddMock } from './actions';
...
export class WsForm extends React.Component {
  ...
  handleSubmit(event) {
    ...
    this.props.initAddMock(this.props.scenarioId, {
      requirements,
      delay,
      interval
    });
...
WsForm.propTypes = {
  initAddMock: PropTypes.func.isRequired,
  scenarioId: PropTypes.string.isRequired
};

const mapStateToProps = state => ({
  scenarioId: getSelectedServerDetails(state).scenario
});
